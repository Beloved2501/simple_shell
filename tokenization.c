...
/**
 * split_words - s function Splits a line into words,.
 *
 * @line: this is the Line to be splitted.,
 * @sep: the Delimiters for split the words.,
 *
 * Return: the funct returns Set of words
 **/
